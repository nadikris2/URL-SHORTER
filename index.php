...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title> URL SHORT USING PHP </title>
    ...
    <body>
        <div class="wrapper">
            <form action ='#' autocomplete="off">
                <input type = "text" spellcheck=" false" name="full_url" placeholder="Enter or place you link " required>
        ...
        <div class ="popup-box">
        <div class="info-box">Ini Link Pendek Anda </div>
        <form action = "#" autocomplete="off">
            <label>Edit Link Pendek anda</label>
            <input type="text" clas="shorten-url" spellcheck="false" required>
